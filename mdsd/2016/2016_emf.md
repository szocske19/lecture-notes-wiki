...
1. Add EAttributes to the classes and also create an AttributeType enumeration. The final model should be similiar to the following figure:

    ![The complete metamodel](mdsd/2016/emf/ERDiagFinal.jpg)
