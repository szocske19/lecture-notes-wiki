...
Since Eclipse Luna, the EMF Ecore visual editor has changed and now based on Sirius changing the extension name to .aird. Legacy diagrams (.ecorediag) cannot be opened with Eclipse Luna Modeling Tools edition.
