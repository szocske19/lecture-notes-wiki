...
1. The editor can validate the model with the check symbol visible in the upper part of the following figure. All of the generated markers are also listed in the Problems View.

    ![Outline view and the diagram validation button](img/emf2/validate.png) 
